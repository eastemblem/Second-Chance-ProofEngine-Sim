...
export const COACH_JOURNEY_STEPS: JourneyStep[] = [
  ...
  // Step 22: Explore Deal Room Features
  {
    ...
    selector: "[data-testid='deal-room-section']",
    coachGuidance: {
      intro: "🎉 Congratulations! You've unlocked Deal Room access! Let's see what's available.",
  ...
  // Step 28: Reach ProofScore 80+
  {
    ...
    scoreThreshold: {
      ...
      high: { min: 80, message: "You're ready for investor introductions — unlock the Deal Room and get connected to investors." },
    },
  },
  ...
  // Step 30: Become Investment Ready
  {
    ...
    selector: "[data-testid='dashboard-header']",
    coachGuidance: {
      intro: "🎉 Congratulations! You've completed the entire ProofCoach journey and are truly investment-ready!",
...
export const TUTORIAL_MECHANICS: Record<string, TutorialMechanic[]> = {
  ...
  "onboarding-venture": [
    ...
    },
    {
      ...
      tips: "Be honest about your stage—early-stage startups get different experiments than scaling companies. Both paths can succeed!",
  ...
  "onboarding-team": [
    ...
    },
    {
      ...
      description: "Add any additional background information that strengthens this team member's profile—education, certifications, awards, publications, or unique domain expertise.",
  ...
  "onboarding-analysis": [
    ...
    },
    {
      ...
      tips: "Your pathway is customized to your current ProofScore. Both paths lead to investment readiness—just at different paces.",
  ...
  "next-steps": [
    ...
    },
    {
      ...
      tips: "Save the email—it contains your login credentials and all access links. Check spam folder if you don't see it within 2 minutes.",
