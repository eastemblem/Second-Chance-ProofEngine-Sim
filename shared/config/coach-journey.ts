  ...
  "validation-map": [
    {
      ...
      description: "Your personalized experiment roadmap for validating key business assumptions across four validation spheres.",
    ...
    },
    {
      ...
      description: "Add pre-designed experiments from our library or create your own custom experiments tailored to your startup.",
      selector: "[data-testid='button-add-experiment']",
      tips: "You can add up to 44 curated experiments designed specifically for your validation journey.",
    ...
    },
    {
      ...
      page: "validation-map",
      title: "Filter & Search",
      description: "Filter experiments by status (pending, in-progress, completed) or sphere (Desirability, Feasibility, Viability, Scaling).",
      selector: "[data-testid='experiment-filters']",
      tips: "Use search to quickly find specific experiments by name or keyword.",
      location: "Above experiment table",
      order: 3,
    },
    {
      id: "experiment-rows",
      ...
      description: "Each row is an experiment you can run to validate your startup. Click the checkbox to mark as complete, edit icon to modify, or info icon for details.",
      selector: "[data-testid='validation-map-grid']",
      tips: "Inline editing: Click on hypothesis, results, insights, or decision fields to edit directly. Changes auto-save after 500ms.",
      location: "Table rows",
      order: 4,
    },
    {
      ...
      description: "Click the info icon (i) on any experiment row to view complete details, methodology, and guidance in a dedicated modal.",
      selector: "[data-testid='validation-map-grid']",
      tips: "Completed experiments unlock ProofTags. Complete 3+ experiments to export your validation map as CSV for ProofVault.",
      location: "Info icon in row",
      order: 5,
    },
  ],
};
