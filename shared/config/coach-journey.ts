  ...
  "onboarding-founder": [
    {
      ...
      description: "Let's get started with your founder profile. This information helps us understand your background and expertise, which factors into your ProofScore.",
      selector: "[data-testid='onboarding-founder-form']",
      tips: "The onboarding process takes about 10-15 minutes total. You can always come back later if needed.",
      location: "Full form",
      order: 1,
    },
    {
      ...
      description: "Provide your full name, email, and role. Your email will be used for login and important updates about your validation journey.",
      selector: "[data-testid='input-full-name']",
      tips: "Use your professional email—this is how investors and team members will recognize you.",
      location: "Top section",
      order: 2,
    },
    {
      ...
      description: "Adding your LinkedIn profile helps establish credibility. Investors often check founder backgrounds, and a strong LinkedIn presence boosts trust.",
      selector: "[data-testid='input-linkedin']",
      tips: "Your LinkedIn should showcase relevant experience, education, and network.",
    ...
    },
    {
      ...
      description: "Indicate if you have technical skills (coding, engineering, data science, etc.). Tech-capable founders often score higher in feasibility validation.",
      selector: "[data-testid='switch-is-technical']",
      tips: "Don't worry if you're not technical—great teams complement skills.",
      location: "Bottom toggle",
      order: 4,
    },
    {
      id: "founder-submit",
      ...
      description: "Once you've filled in your details, click 'Continue to Venture Info' to move to the next step where you'll describe your startup.",
      selector: "[data-testid='button-continue-venture']",
      tips: "You can always come back to edit this information later from your dashboard.",
  ...
  "onboarding-venture": [
    {
      ...
      description: "Now let's capture details about your venture. This information is critical for your ProofScore calculation and helps us assign relevant validation experiments.",
      selector: "[data-testid='onboarding-venture-form']",
      tips: "Be specific and honest—our AI analyzes your pitch deck against these details.",
      location: "Full form",
      order: 1,
    },
    {
      ...
      description: "Enter your company name, website (if available), and growth stage. The stage helps us calibrate expectations—early ideas vs. revenue-generating companies are evaluated differently.",
      selector: "[data-testid='input-company-name']",
      tips: "If you don't have a website yet, that's okay—just leave it blank.",
      location: "Top fields",
      order: 2,
    },
    {
      ...
      description: "Clearly articulate the problem you're solving and your unique solution. This is your value proposition—make it compelling and specific.",
      selector: "[data-testid='textarea-problem-statement']",
      tips: "Great problem statements are specific: Who has this problem? How often? How painful is it?",
    ...
    },
    {
      ...
      description: "Define your target market, industry, and estimated market size. Investors need to see that you're addressing a large enough opportunity to justify investment.",
      selector: "[data-testid='input-target-market']",
      tips: "Be realistic about market size—inflated numbers hurt credibility.",
    ...
    },
    {
      id: "venture-submit",
      page: "onboarding-venture",
      title: "Proceed to Team",
      description: "After completing venture details, click 'Continue to Team' to add team members (optional but recommended).",
      selector: "[data-testid='button-continue-team']",
      tips: "Strong teams increase ProofScore—investors bet on people, not just ideas.",
      location: "Bottom button",
      order: 5,
    },
  ],
