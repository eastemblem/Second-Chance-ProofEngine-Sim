...
export const TUTORIAL_MECHANICS: Record<string, TutorialMechanic[]> = {
  ...
  "validation-map": [
    ...
    },
    {
      ...
      selector: "[data-testid='experiment-actions-header']",
    ...
    },
    {
      ...
      description: "Each column represents a step in the scientific method: your hypothesis, what you'll measure, actual results, analysis (why), insights learned, and your decision (pivot, persevere, or iterate).",
      selector: "[data-testid='validation-map-grid']",
      tips: "This structured approach helps you think like a scientist about your business.",
      location: "Table area",
      order: 5,
    },
    {
      ...
      page: "validation-map",
      title: "Row Actions & Inline Editing",
      description: "Each experiment row has action buttons: Edit (pencil icon), Delete (trash icon), and Complete (green button). Click any editable field (hypothesis, results, insights, decision) to edit inline—changes auto-save after 500ms.",
      selector: "[data-testid='experiment-table-body']",
      tips: "Mark experiments 'Complete' to unlock ProofTags. Export to CSV after completing 3+ experiments to add to your ProofVault.",
      location: "Table rows",
      order: 6,
    },
  ],
