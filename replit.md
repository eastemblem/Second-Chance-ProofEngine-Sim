...
- **Automated Flow Fix**: Corrected certificate and report generation to automatically capture `eastemblemFileId`, `file_size`, and `folder_id` from API response without manual intervention
