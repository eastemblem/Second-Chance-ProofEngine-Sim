...
- **Automated Flow Fix**: Corrected certificate and report generation to automatically capture `eastemblemFileId` from API response without manual intervention
